        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Products_Stock", "[AvailableStock] >= 0");
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_Users_Role", "([Role] = 'Admin' AND [DealerId] IS NULL) OR ([Role] = 'Dealer' AND [DealerId] IS NOT NULL)");
                    table.ForeignKey(
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_DealerId_CreatedAt",
                table: "Orders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderStatusHistories_OrderId_Timestamp",
